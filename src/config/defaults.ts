...
export const DEFAULT_CONFIG: WorkflowConfig = {
  ...
  budgets: { maxTotalRequests: 120, maxTransitions: 40, maxWallClockMs: 7200000, perRole: { planner: { maxAttempts: 2 }, implementation: { maxAttempts: 6 }, security: { maxAttempts: 3 }, review: { maxAttempts: 3 }, scout: { maxAttempts: 1 }, archivist: { maxAttempts: 1 } } },
