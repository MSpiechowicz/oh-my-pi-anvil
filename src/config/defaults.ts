...
export const DEFAULT_CONFIG: WorkflowConfig = {
  ...
  agents: {
    ...
    implementation: { agent: "orchestrator-implementation" },
    security: { agent: "orchestrator-security" },
    review: { agent: "orchestrator-reviewer" },
  },
  checks: [],
  checksFailFast: true,
  ...
  persistence: { root: ".omp/.orchestrator", keepAgentRawArtifacts: true, keepCommandLogs: true, persistRenderedPrompts: false },
