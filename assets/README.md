...
The supplied Anvil artwork is intentionally kept local so README previews work offline and package consumers can replace the art without touching code.

- `anvil-team.webp` is the wide brand tableau.
